...
export default function Login() {
  ...
  const handleDemoLogin = async (role: UserRole) => {
    ...
    try {
      const success = await login(roleConfig.credentials.email, roleConfig.credentials.password);
      if (!success) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-300 via-yellow-200 to-yellow-100 flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-32 right-16 w-24 h-24 bg-yellow-400 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
          <div className="absolute top-1/2 left-10 w-16 h-16 bg-yellow-600 rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
        </div>
        ...
        <div className="relative z-10 text-center">
          ...
          <div className="text-center space-y-4">
            <h1 className="text-6xl font-bold text-yellow-600 drop-shadow-lg" style={{
            ...
            <div className="space-y-2">
              <p className="text-xl font-semibold text-yellow-800">Premium Tyre Services</p>
              <p className="text-lg text-yellow-700">Professional • Reliable • Fast</p>
            </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="text-center text-sm text-yellow-800 bg-white/50 backdrop-blur-sm rounded-lg p-4">
            <p className="font-medium mb-1">Professional Tyre Management System</p>
